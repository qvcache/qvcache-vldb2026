#!/usr/bin/env python3
"""
Backend-only benchmark using Qdrant backend (without QVCache)

This script benchmarks the Qdrant backend directly, processing splits sequentially.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Backend-only benchmark experiment with Qdrant backend")
